            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    ...
                    <header class="pageheader">
                        <h3><i class="fa fa-home"></i> Ajouter Categorie </h3>
                            ...
                            <div class="col-lg-6">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Informations Categorie</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    ...
                                    {
                                        $categ=FCategorie::selectOne($_GET['id']);
                                    }
                                    if(isset($_SESSION['err'])){
                                        unset($_SESSION['err']);
                                    }
                                    ?>
                                    <form method="post" action="controllers/addCategory.php" class="panel-body form-horizontal">

                                        <!--Text Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Designation</label>
                                            <div class="col-md-9">
                                                <input value="<?=!empty($categ['designation'])?$categ['designation']:''?>" name="designation" type="text" id="demo-text-input" class="form-control" placeholder="Designation">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input value="<?=!empty($categ['code'])?$categ['code']:''?>" name="code" type="text" id="demo-email-input" class="form-control" placeholder="Code">

                                            </div>
                                        </div>
                                        <!--Password-->
                                        <input value="<?=!empty($categ['id'])?$categ['id']:''?>" type="hidden" name="up" id="demo-password-input" class="form-control" placeholder="Mot de passe">
