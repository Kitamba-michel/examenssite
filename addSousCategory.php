            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    ...
                    <header class="pageheader">
                        <h3><i class="fa fa-home"></i> Ajouter Sous Categorie </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">Menu</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Acceuil </a> </li>
                                <li class="active"> Ajouter Sous Categorie </li>
                            </ol>
                        </div>
                    </header>
                    <!--Page content-->
                            ...
                            <div class="col-lg-6">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Informations Sous Categorie</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    ...
                                    ?>
                                    <form method="post" action="controllers/addSousCategory.php" class="panel-body form-horizontal">

                                        <!--Text Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Designation</label>
                                            <div class="col-md-9">
                                                <input name="designation" type="text" id="demo-text-input" class="form-control" placeholder="Designation">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="code" type="text" id="demo-email-input" class="form-control" placeholder="Code">

                                            </div>
                                        </div>
                                        <!--Password-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Categorie</label>
                                            <div class="col-md-9">
                                                <select name="categorie" type="text" id="demo-text-input" class="form-control">
                                                    <?php foreach (FCategorie::selectAll() as $item):?>
