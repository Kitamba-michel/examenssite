                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel">
                                    ...
                                    ?>
                                    <form method="post" action="controllers/preCommande.php" class="panel-body form-horizontal">

                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-email-input">Code</label>
                                            <div class="col-md-9">
                                                <input value="CMD00<?=count(FCmdClient::selectAll())+1;?>" disabled type="text" id="demo-email-input" class="form-control" placeholder="Code">

                                            </div>
                                        </div>
                                        <input name="code" value="CMD00<?=count(FCmdClient::selectAll())+1;?>"  type="hidden" id="demo-email-input" class="form-control" placeholder="Code">

                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Client</label>
                                            <div class="col-md-9">
                                                <select name="client" class="form-control">
                                                    <?php foreach (FClient::selectAll() as $item):?>
                                      ...
                                      <center><button type="submit" class="btn btn-primary">Suivant</button> </center>
                                    </form>
                                    <!--===================================================-->
