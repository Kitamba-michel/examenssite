            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    ...
                    <header class="pageheader">
                        <h3><i class="fa fa-home"></i> Modifier profil </h3>
                            ...
                            <div class="col-lg-6">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">Uplaode Profil</h3>
                                    </div>
                                    <!-- BASIC FORM ELEMENTS -->
                                    <!--===================================================-->
                                    ...
                                    ?>
                                    <form method="post" action="controllers/updateProfil.php" class="panel-body form-horizontal" enctype="multipart/form-data">

                                        <!--Text Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Image</label>
                                            <div class="col-md-9">
                                                <input  name="img" type="file" id="demo-text-input" class="form-control" formenctype="multipart/form-data">

                                            </div>
                                        </div>

                                      <center><button type="submit" class="btn btn-primary">Uplaod</button> </center>
                                    </form>
                                    <!--===================================================-->
