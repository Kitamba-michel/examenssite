            ...
            <div class="boxed">
                ...
                <section id="content-container">
                    ...
                    <header class="pageheader">
                        <h3><i class="fa fa-home"></i> Ajouter Fournisseur </h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="panel">
                                    ...
                                    {
                                        $fourni=FFournisseur::selectOne($_GET['id']);
                                    }
                                    if(isset($_SESSION['err'])){
                                        unset($_SESSION['err']);
                                    }
                                    ?>
                                    <form method="post" action="controllers/addFournisseur.php" class="panel-body form-horizontal">
                                        <!--Static-->

                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Nom</label>
                                            <div class="col-md-9">
                                                <input value="<?=!empty($fourni['nom'])?$fourni['nom']:''?>" name="nom" type="text" id="demo-text-input" class="form-control" placeholder="Nom fournisseur">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input value="<?=!empty($fourni['codeFournisseur'])?$fourni['codeFournisseur']:''?>" name="codeFournisseur" type="text" id="demo-email-input" class="form-control" placeholder="Code Fournisseur">

                                            </div>
                                        </div>
                                        <!--Password-->

                                        <input value="<?=!empty($fourni['id'])?$fourni['id']:''?>" type="hidden" name="up" id="demo-password-input" class="form-control" placeholder="Mot de passe">
